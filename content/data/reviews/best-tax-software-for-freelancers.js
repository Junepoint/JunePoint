module.exports = {
  slug: 'best-tax-software-for-freelancers',
  title: 'Best Tax Software for Freelancers & Self-Employed (2026)',
  h1: 'Best tax software for freelancers',
  ...
  blocks: [
    ...
    {
      t: 'p',
      x: 'The 15.3% breaks down as 12.4% Social Security, which applies only up to the annual wage base, and 2.9% Medicare, which has no cap. An additional 0.9% Medicare surtax applies above $200,000 single or $250,000 married filing jointly.',
    },
    {
      t: 'note',
      kind: 'tip',
    ...
    {
      t: 'p',
      x: 'If you expect to owe $1,000 or more in tax, the IRS requires payment through the year rather than in one lump at filing. Deadlines fall on roughly 15 April, 15 June, 15 September and 15 January.',
    },
    {
      t: 'p',
      x: 'The most useful thing to know is the **safe harbour**. Pay either of these and you avoid the underpayment penalty regardless of what you eventually owe:',
    },
    {
      t: 'ul',
      items: [
    ...
    {
      t: 'p',
      x: 'The prior-year safe harbour is the practical one: it is a known number, so you can divide last year’s total tax by four and pay that, without forecasting an unpredictable freelance year. If you earn far more, you settle the difference in April with no penalty.',
    },
    {
      t: 'note',
      kind: 'warn',
...

    {
      ...
      cons: [
        ...
        'Persistent upselling throughout the process',
        'State returns priced separately and not cheaply',
      ],
    },

    {
      ...
      award: 'Best if you may want a human',
      summary:
      ...
      cons: ['Still expensive relative to budget options', 'State returns extra', 'Guidance marginally behind TurboTax'],
    },
    ...
    { t: 'h2', x: 'Deductions freelancers most often miss' },
    {
      t: 'ul',
      items: [
      ...
      items: [
        {
          ...
          a: '25–35% of net profit is the common guidance, and it is a reasonable default. The floor is the 15.3% self-employment tax plus your income tax bracket, less the QBI deduction and business expenses. Higher earners in high-tax states should be at the top of that range or above it. Move it to a separate account on receipt of every payment.',
        },
        {
        ...
        },
        {
          ...
          a: 'FreeTaxUSA includes Schedule C and self-employment tax free for federal, charging roughly $15 per state return. The major brands typically charge $85–$130 for the equivalent federal return. Note that the well-advertised "free" tiers from other providers generally exclude self-employment income entirely.',
        },
        {
          q: 'Can I deduct my home office?',
          a: 'If the space is used regularly and exclusively for business, yes. The simplified method is $5 per square foot up to 300 square feet, requiring no expense tracking. The actual-expense method can be worth more but needs records of rent or mortgage interest, utilities and the square-footage percentage.',
        },
        {
  ...
  related: ['/tools/mortgage-payoff-calculator/', '/reviews/best-payroll-software-small-business/', '/tools/saas-seat-cost-calculator/'],
};
