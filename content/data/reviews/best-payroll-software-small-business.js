module.exports = {
  ...
  h1: 'Best payroll software for small business',
  ...
  blocks: [
...

    {
      ...
      award: 'Best if your books are already in QuickBooks',
      summary:
...

    {
      ...
      award: 'Best value for very small businesses',
      summary:
    ...
    },
    {
      t: 'note',
      kind: 'tip',
      title: 'Ask before the offer letter, not after',
    ...
    { t: 'h2', x: 'Switching providers without breaking anything' },
    {
      t: 'ol',
      items: [
      ...
      items: [
        {
          ...
          a: 'Typically $35–$80 per month as a base fee plus $5–$12 per employee. A ten-person company generally lands between $100 and $180 a month. Additional states, year-end forms and off-cycle runs can add meaningfully to that, so compare on total annual cost rather than the headline.',
        },
        {
          q: 'What is the difference between full-service and self-service payroll?',
          a: 'Full-service means the provider calculates, remits and files your payroll taxes. Self-service calculates the numbers and leaves filing and payment to you. Given that payroll tax penalties can be assessed against company officers personally, self-service is rarely worth the saving.',
        },
        {
        ...
        },
        {
          ...
          a: '1 January, so the new provider handles a full tax year and produces clean W-2s. A quarter boundary is the next best option. Mid-quarter switches require migrating year-to-date figures accurately, which is the main source of year-end errors.',
        },
      ],
    },
  ],

  related: ['/tools/saas-seat-cost-calculator/', '/reviews/best-tax-software-for-freelancers/', '/reviews/best-crm-for-small-business/'],
};
