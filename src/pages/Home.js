...
export default function Home() {
  ...
  // Removed scroll listener - no parallax effect for better performance

  // Removed auto-rotating service cards for better performance
  // useEffect(() => {
  ...
  return (
    <div className="bg-white text-slate-800 min-h-screen overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div 
          className="absolute w-96 h-96 bg-blue-300/20 rounded-full blur-xl"
          style={{ 
            top: '10%', 
            left: '10%'
          }}
        />
        <div 
          className="absolute w-96 h-96 bg-sky-300/20 rounded-full blur-xl"
          style={{ 
            top: '60%', 
            right: '10%'
          }}
        />
        <div 
          className="absolute w-96 h-96 bg-cyan-300/20 rounded-full blur-xl"
          style={{ 
            bottom: '10%', 
            left: '50%'
          }}
      ...
      <nav className="fixed top-0 w-full z-50 backdrop-blur-md bg-white/90 border-b border-slate-200/50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex gap-8 items-center">
            ...
            {/* Static pages generated by content/build.js use a plain <a>, not a Router Link. */}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((service, idx) => (
              <Link
                key={idx}
                to={service.link}
                className={`group relative p-8 bg-white border rounded-3xl hover:border-blue-300 cursor-pointer transition-all duration-300 will-change-transform block ${
      ...
      <footer className="relative py-12 px-6 border-t border-slate-200 bg-slate-50">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-wrap gap-6 justify-center">
            <a href="/resources/" className="text-slate-500 hover:text-blue-600 transition-colors">Resources</a>
            <a href="/tools/" className="text-slate-500 hover:text-blue-600 transition-colors">Free Tools</a>
            <a href="/guides/" className="text-slate-500 hover:text-blue-600 transition-colors">Guides</a>
