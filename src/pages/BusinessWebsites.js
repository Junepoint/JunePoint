...
import { businessWebsites } from '../data/projectsData';
...
export default function BusinessWebsites() {
  return (
    <div className="bg-white min-h-screen">
      ...
      <div className="pt-20">
        <ProjectDisplay 
          projects={businessWebsites}
          title="Business Websites"
          description="Responsive, modern business sites powered by full-stack technologies with seamless user experiences and professional design."
        />
      </div>
    </div>
  );
