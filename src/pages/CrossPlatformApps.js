...
import { crossPlatformApps } from '../data/projectsData';
...
export default function CrossPlatformApps() {
  return (
    <div className="bg-white min-h-screen">
      ...
      <div className="pt-20">
        <ProjectDisplay 
          projects={crossPlatformApps}
          title="Full-Stack Cross-Platform Apps"
          description="Native-quality iOS and Android apps from a single codebase using React Native, Expo, and cloud infrastructure."
        />
      </div>
    </div>
  );
